...
exports.admin = function (method, endpoint) {
	console.log (('['+ clfDate () + '] ').magenta + 'Admin'.underline.yellow + '\t' +
			method.yellow + ' ' + endpoint.magenta);
};

exports.job = function (job, message) {
	console.log (('['+ clfDate () + '] ').magenta + 'Job'.cyan + '\t' +
			job.yellow + ' ' + message.blue);
};

exports.joberror = function (job, message) {
	console.log (('['+ clfDate () + '] ').magenta + 'Job'.cyan + '\t' +
			job.yellow + ' ' + message.red);
};
